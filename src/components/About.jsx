    ...
    <section id="about" className="about">
      <div data-aos="fade-down" className="about__header-text">
        ...
        <p className="about__sub">
          ...
          Front-End de forma autodidata. Tenho experiência com trabalho em
          equipe e pretendo me tornar Full-Stack.
        </p>
      </div>
      <div className="about__content">
        <div className="about__info">
          ...
          <p className="about__info-text">
            ...
            exemplo, como um aplicativo ou um página web foram criados. Por ter
            essa ambição de conhecimento já trilhei por algumas áreas da
            ...
            e coisas relacionadas, não descarto a importância do Back-end e já
            estou estudando sobre essa área.
          </p>
        </div>
